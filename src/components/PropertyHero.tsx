...
const PropertyHero = ({ coverImage = '/public/condos/placeholder.jpg' }: PropertyHeroProps) => {
  ...
  return (
    <section className="relative overflow-hidden rounded-2xl bg-slate-950 p-6 md:p-8 mb-6 border border-white/10 shadow-xl">
      ...
      />
      {/* Dark gradient overlay to keep text contrast high and readable */}
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-slate-900/60 backdrop-blur-sm border border-amber-500/20 p-4 rounded-xl flex items-start gap-4 transition-all hover:bg-slate-900/80">
            <AlertTriangle className="w-5 h-5 text-amber-500 shrink-0 mt-0.5" />
            <div className="space-y-1">
              <p className="text-amber-200 text-[10px] font-bold uppercase tracking-[0.1em]">Forensic Audit Disclaimer</p>
              <p className="text-slate-200 text-[11px] leading-relaxed opacity-90">
